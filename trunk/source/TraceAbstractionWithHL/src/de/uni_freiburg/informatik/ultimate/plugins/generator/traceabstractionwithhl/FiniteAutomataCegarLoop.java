...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.automataminimization.AutomataMinimization;
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.automataminimization.AutomataMinimization.AutomataMinimizationTimeout;
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.errorabstraction.ErrorGeneralizationEngine;
...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.pathinvariants.PathInvariantsGenerator;
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.pathinvariants.internal.DangerInvariantGuesser;
...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.preferences.TraceAbstractionWithHLPreferenceInitializer.CounterexampleSearchStrategy;
...
//		}
	...
	protected boolean refineAbstraction() throws AutomataLibraryException {
		...
		if (mErrorGeneralizationEngine.hasAutomatonInIteration(getIteration())) {
			...
			mLogger.info("Forget about error automata! This is FloydHoare!");
			...
			mLogger.info(enhanceMode.toString());
...
//		final var states_minimized = mAbstraction.getStates();
//		for (final IPredicate state : states_minimized) {
//			mLogger.info(state.getClass().getName());
//			mLogger.info(state.toString());
//		}
		mLogger.info("Minimization finished!");
...
//				}
	...
	private static SearchStrategy getSearchStrategy(final IPreferenceProvider mPrefs) {
		switch (mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_COUNTEREXAMPLE_SEARCH_STRATEGY,
