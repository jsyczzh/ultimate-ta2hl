...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.PathProgramDumper.InputMode;
...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.preferences.TraceAbstractionWithHLPreferenceInitializer.PathProgramDumpStop;
...
public class PathProgramDumpController<L extends IIcfgTransition<?>> {
	...
	public PathProgramDumpController(final IUltimateServiceProvider services, final TAPreferences pref,
		...
		mDumpIfNotPerfect = services.getPreferenceProvider(Activator.PLUGIN_ID)
				.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_DUMP_PATH_PROGRAM_IF_NOT_PERFECT);
		mDumpIfAnalyzedTooOften = services.getPreferenceProvider(Activator.PLUGIN_ID)
				.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_DUMP_PATH_PROGRAM_IF_ANALYZED_TOO_OFTEN);
		...
		mDumpStopMode = services.getPreferenceProvider(Activator.PLUGIN_ID).getEnum(
				TraceAbstractionWithHLPreferenceInitializer.LABEL_DUMP_PATH_PROGRAM_STOP_MODE, PathProgramDumpStop.class);
