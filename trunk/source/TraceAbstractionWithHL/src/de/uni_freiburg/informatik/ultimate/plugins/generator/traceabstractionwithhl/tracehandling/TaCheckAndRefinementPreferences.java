...
public class TaCheckAndRefinementPreferences<LETTER extends IIcfgTransition<?>> implements ITraceCheckPreferences {
	...
	public TaCheckAndRefinementPreferences(final IUltimateServiceProvider services, final TAPreferences taPrefs,
		...
		this(services, taPrefs, interpolationTechnique, simplificationTechnique, cfgSmtToolkit, predicateFactory,
				icfgContainer, taPrefs.getRefinementStrategy(), services.getPreferenceProvider(Activator.PLUGIN_ID)
						.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_COMPUTE_COUNTEREXAMPLE));
	}
	...
	public TaCheckAndRefinementPreferences(final IUltimateServiceProvider services, final TAPreferences taPrefs,
		...
		mUnsatCores = ultimatePrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_UNSAT_CORES, UnsatCores.class);
		mUseLiveVariables = ultimatePrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_LIVE_VARIABLES);
		mUseAbstractInterpretationPredicates = ultimatePrefs
				.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_ABSTRACT_INTERPRETATION_FOR_PATH_INVARIANTS);
		mUseInterpolantConsolidation =
				ultimatePrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_INTERPOLANTS_CONSOLIDATION);
		mUseNonlinearConstraints = ultimatePrefs
				.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_NONLINEAR_CONSTRAINTS_IN_PATHINVARIANTS);
		mUseVarsFromUnsatCoreForPathInvariants =
				ultimatePrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_UNSAT_CORES_IN_PATHINVARIANTS);
		mUseWeakestPreconditionForPathInvariants = ultimatePrefs
				.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_WEAKEST_PRECONDITION_IN_PATHINVARIANTS);
		mComputeCounterexample = computeCounterexample;
		mUsePredicateTrieBasedPredicateUnifier = ultimatePrefs
				.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_USE_PREDICATE_TRIE_BASED_PREDICATE_UNIFIER);
		mUseMinimalUnsatCoreEnumerationForSmtInterpol = ultimatePrefs.getBoolean(
				TraceAbstractionWithHLPreferenceInitializer.LABEL_USE_MINIMAL_UNSAT_CORE_ENUMERATION_FOR_SMTINTERPOL);
		mAdditionalSolverOptions =
				ultimatePrefs.getKeyValueMap(TraceAbstractionWithHLPreferenceInitializer.LABEL_ADDITIONAL_SMT_OPTIONS);
	}
	...
	public static class TaAssertCodeBlockOrder extends AssertCodeBlockOrder {
		...
		public TaAssertCodeBlockOrder(final IPreferenceProvider ups) {
			super(ups.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_ASSERT_CODEBLOCKS_INCREMENTALLY,
					AssertCodeBlockOrderType.class),
					ups.getEnum(
							TraceAbstractionWithHLPreferenceInitializer.LABEL_ASSERT_CODEBLOCKS_HEURISTIC_PARTITIONING_STRATEGY,
							SmtFeatureHeuristicPartitioningType.class),
					ups.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_ASSERT_CODEBLOCKS_HEURISTIC_SCORING_METHOD,
							ScoringMethod.class),
					ups.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_ASSERT_CODEBLOCKS_HEURISTIC_NUM_PARTITIONS),
					ups.getDouble(
							TraceAbstractionWithHLPreferenceInitializer.LABEL_ASSERT_CODEBLOCKS_HEURISTIC_SCORE_THRESHOLD));
		}
