 ...
 */
package de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.preferences;
...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.Activator;
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.preferences.TraceAbstractionWithHLPreferenceInitializer.CoinflipMode;
...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.preferences.TraceAbstractionWithHLPreferenceInitializer.FloydHoareAutomataReuseEnhancement;
...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.preferences.TraceAbstractionWithHLPreferenceInitializer.McrInterpolantMethod;
...
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.preferences.TraceAbstractionWithHLPreferenceInitializer.OrderOfErrorLocations;
import de.uni_freiburg.informatik.ultimate.plugins.generator.traceabstractionwithhl.preferences.TraceAbstractionWithHLPreferenceInitializer.RefinementStrategy;
...
public final class TAPreferences {
	...
	public TAPreferences(final IUltimateServiceProvider services) {
		...
		mInterprocedural = mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_INTERPROCEDURAL);

		mMaxIterations = mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_USERLIMIT_ITERATIONS);
		mWatchIteration = mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_WATCHITERATION);

		mArtifact = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_ARTIFACT, Artifact.class);

		mHoareAnnotationPositions = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_HOARE_POSITIONS,
				HoareAnnotationPositions.class);

		mInterpolation = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_INTERPOLATED_LOCS,
				InterpolationTechnique.class);

		mInterpolantAutomaton = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_INTERPOLANT_AUTOMATON,
				InterpolantAutomaton.class);

		mDumpAutomata = mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_DUMPAUTOMATA);

		mAutomataFormat = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_AUTOMATAFORMAT, Format.class);

		mDumpPath = mPrefs.getString(TraceAbstractionWithHLPreferenceInitializer.LABEL_DUMPPATH);
		mDumpOnlyReuseAutomata = mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_DUMP_ONLY_REUSE);

		mDeterminiation = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_INTERPOLANT_AUTOMATON_ENHANCEMENT,
				InterpolantAutomatonEnhancement.class);

		mHoareTripleChecks = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_HOARE_TRIPLE_CHECKS,
				HoareTripleChecks.class);

		mMinimize = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_MINIMIZE, Minimization.class);

		mAutomataTypeConcurrency =
				mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_CONCURRENCY, Concurrency.class);

		mLimitTraceHistogram = mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_USERLIMIT_TRACE_HISTOGRAM);
		mErrorLocTimeLimit = mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_USERLIMIT_TIME);
		mLimitPathProgramCount = mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_USERLIMIT_PATH_PROGRAM);

		mCollectInterpolantStatistics =
				mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_COMPUTE_INTERPOLANT_SEQUENCE_STATISTICS);
		...
		mHeuristicEmptinessCheck =
				mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_HEURISTIC_EMPTINESS_CHECK);

		mHeuristicEmptinessCheckAStarHeuristic =
				mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_HEURISTIC_EMPTINESS_CHECK_ASTAR_HEURISTIC,
						AStarHeuristic.class);

		mHeuristicEmptinessCheckSmtFeatureScoringMethod =
				mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_HEURISTIC_EMPTINESS_CHECK_SCORING_METHOD,
						ScoringMethod.class);

		mHeuristicEmptinessCheckAStarHeuristicRandomSeed = mPrefs.getInt(
				TraceAbstractionWithHLPreferenceInitializer.LABEL_HEURISTIC_EMPTINESS_CHECK_ASTAR_RANDOM_HEURISTIC_SEED);

		mSMTFeatureExtraction = mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_SMT_FEATURE_EXTRACTION);
		mSMTFeatureExtractionDumpPath =
				mPrefs.getString(TraceAbstractionWithHLPreferenceInitializer.LABEL_SMT_FEATURE_EXTRACTION_DUMP_PATH);
		mOverrideInterpolantAutomaton =
				mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_OVERRIDE_INTERPOLANT_AUTOMATON);
		mMcrInterpolantMethod = mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_MCR_INTERPOLANT_METHOD,
		...
		mLbeIndependenceSettings = new IndependenceSettings(
				mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_INDEPENDENCE_PLBE, IndependenceType.class),
				...
				mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_SEMICOMM_PLBE),
	...
	public boolean stopAfterFirstViolation() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_STOP_AFTER_FIRST_VIOLATION);
	}

	public OrderOfErrorLocations getOrderOfErrorLocations() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_ORDER_OF_ERROR_LOCATIONS,
				OrderOfErrorLocations.class);
	}

	public boolean readInitialProof() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_READ_INITIAL_PROOF_ASSERTIONS_FROM_FILE);
	}

	public FloydHoareAutomataReuse getFloydHoareAutomataReuse() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_FLOYD_HOARE_AUTOMATA_REUSE,
				FloydHoareAutomataReuse.class);
	}

	public FloydHoareAutomataReuseEnhancement getFloydHoareAutomataReuseEnhancement() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_FLOYD_HOARE_AUTOMATA_REUSE_ENHANCEMENT,
	...
	public boolean useSeparateSolverForTracechecks() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_SEPARATE_SOLVER);
	}
	...
	public boolean differenceSenwa() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_DIFFERENCE_SENWA);
	}
	...
	public boolean computeProcedureContracts() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_COMPUTE_PROCEDURE_CONTRACTS);
	}
	...
	public boolean cutOffRequiresSameTransition() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_CUTOFF);
	}

	public boolean unfoldingToNet() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_BACKFOLDING);
	}

	public EventOrderEnum eventOrder() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_CONFIGURATION_ORDER, EventOrderEnum.class);
	}

	public LooperCheck looperCheck() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_LOOPER_CHECK_PETRI, LooperCheck.class);
	}

	public boolean applyOneShotLbe() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_PETRI_LBE_ONESHOT);
	}

	public boolean applyOneShotPOR() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_ONESHOT);
	}

	public PartialOrderMode getPartialOrderMode() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_MODE, PartialOrderMode.class);
	}

	public boolean dumpIndependenceScript() {
		return mPrefs.getBoolean(TraceAbstractionWithHLPreferenceInitializer.LABEL_DUMP_INDEPENDENCE_SCRIPT);
	}

	public String independenceScriptDumpPath() {
		return mPrefs.getString(TraceAbstractionWithHLPreferenceInitializer.LABEL_INDEPENDENCE_SCRIPT_DUMP_PATH);
	}

	public OrderType getDfsOrderType() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_DFS_ORDER, OrderType.class);
	}

	public long getDfsOrderSeed() {
		return mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_DFS_RANDOM_SEED);
	}

	public CoinflipMode useCoinflip() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_COINFLIP_MODE, CoinflipMode.class);
	}

	public double getCoinflipProbability(final int iteration) {
		final int basicProbability = mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_COINFLIP_PROB);
		final int probabilityIncrement =
				mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_COINFLIP_INCREMENT);
	...
	public int coinflipSeed() {
		return mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_COINFLIP_SEED);
	}

	public int getNumberOfIndependenceRelations() {
		return mPrefs.getInt(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_NUM_INDEPENDENCE);
	}
	...
	public IndependenceSettings porIndependenceSettings(final int index) {
		...
		if (mPorIndependenceSettings[index] == null) {
			mPorIndependenceSettings[index] = new IndependenceSettings(
					mPrefs.getEnum(getLabel(TraceAbstractionWithHLPreferenceInitializer.LABEL_INDEPENDENCE_POR, index),
							IndependenceSettings.DEFAULT_INDEPENDENCE_TYPE, IndependenceType.class),
					mPrefs.getEnum(getLabel(TraceAbstractionWithHLPreferenceInitializer.LABEL_POR_ABSTRACTION, index),
							IndependenceSettings.DEFAULT_ABSTRACTION_TYPE, AbstractionType.class),
					mPrefs.getBoolean(getLabel(TraceAbstractionWithHLPreferenceInitializer.LABEL_COND_POR, index),
							IndependenceSettings.DEFAULT_USE_CONDITIONAL),
					mPrefs.getBoolean(getLabel(TraceAbstractionWithHLPreferenceInitializer.LABEL_SEMICOMM_POR, index),
							IndependenceSettings.DEFAULT_USE_SEMICOMMUTATIVITY),
					mPrefs.getEnum(getLabel(TraceAbstractionWithHLPreferenceInitializer.LABEL_INDEPENDENCE_SOLVER_POR, index),
							IndependenceSettings.DEFAULT_SOLVER, ExternalSolver.class),
					mPrefs.getLong(getLabel(TraceAbstractionWithHLPreferenceInitializer.LABEL_INDEPENDENCE_SOLVER_TIMEOUT_POR,
	...
	private static String getLabel(final String label, final int index) {
		return TraceAbstractionWithHLPreferenceInitializer.getSuffixedLabel(label, index);
	}
	...
	public SimplificationTechnique getSimplificationTechnique() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_SIMPLIFICATION_TECHNIQUE,
	...
	public RefinementStrategy getRefinementStrategy() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_REFINEMENT_STRATEGY,
				RefinementStrategy.class);
	}

	public RefinementStrategy getMcrRefinementStrategy() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_MCR_REFINEMENT_STRATEGY,
				RefinementStrategy.class);
	}

	public RefinementStrategy getAcceleratedInterpolationRefinementStrategy() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_ACIP_REFINEMENT_STRATEGY,
				RefinementStrategy.class);
	}

	public RefinementStrategyExceptionBlacklist getRefinementStrategyExceptionSpecification() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_REFINEMENT_STRATEGY_EXCEPTION_BLACKLIST,
	...
	public LoopAccelerators getLoopAccelerationTechnique() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_ACCELINTERPOL_LOOPACCELERATION_TECHNIQUE,
	...
	public IndependenceConditions getSymbolicRelationMode() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_COMMUTATIVITY_COND_SYNTHESIS,
				IndependenceConditions.class);
	}

	public RefinementStrategy getConditionalCommutativityRefinementStrategy() {
		return mPrefs.getEnum(TraceAbstractionWithHLPreferenceInitializer.LABEL_COMMUTATIVITY_COND_SYNTHESIS_STRATEGY,
				RefinementStrategy.class);
	}
